...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2022 a las 03:49:48
...
--
-- Estructura de tabla para la tabla `rondapartida`
--

CREATE TABLE `rondapartida` (
  `id_ronda` int(1) NOT NULL,
  `id_partida` int(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indices de la tabla `rondapartida`
--
ALTER TABLE `rondapartida`
...
--
-- Filtros para la tabla `rondapartida`
--
ALTER TABLE `rondapartida`
  ADD CONSTRAINT `rondapartida_ibfk_1` FOREIGN KEY (`id_partida`) REFERENCES `partida` (`id_partida`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `rondapartida_ibfk_2` FOREIGN KEY (`id_ronda`) REFERENCES `ronda` (`id_ronda`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
